...
public class SortCoActors {
     ...
     *
     */
    public static class SortCoActorsMapper extends
     ...
     *
     */
    public static class SortCoActorsReducer
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length != 2) {
            System.err.println("Usage: "+SortCoActors.class.getName()+" <in> <out>");
            System.exit(2);
        }
        ...
        job.setMapperClass(SortCoActorsMapper.class); // no combiner this time!
        job.setReducerClass(SortCoActorsReducer.class);

        FileInputFormat.setInputPaths(job, new Path(inputLocation));
        FileOutputFormat.setOutputPath(job, new Path(outputLocation));

        job.setJarByClass(SortCoActors.class);
